...
package com.android.cdac.sensormusicplayer;

import com.android.cdac.sensormusicplayer.MusicUtils.ServiceToken;
import com.android.cdac.sensormusicplayer.IMediaPlaybackService;
...
View.OnTouchListener, View.OnLongClickListener
{
	...
	private CheckBox accelChkBox, proximityChkBox, lightChkBox;

	
	//Added By Prasenjit
	SensorEventListener listenerfromMainApp, accelSensorListener, proximitySensorListener;
	ContextAwareFunction caf;
	SensorController1 controller  = SensorController1.getInstance(this);
	...
	public void onCreate(Bundle icicle)
	{
		...
		accelChkBox = (CheckBox) findViewById(R.id.accelerometer);
		proximityChkBox =(CheckBox) findViewById(R.id.proximty);
		...
		seekmethod = 1;
		getSensorServices();
		getProximitySensorService();
		accelChkBox.setOnClickListener(mAccelSensorListener);
		proximityChkBox.setOnClickListener(mProximitySensorListener);
	...
	/**
	 * Method to work with Proximity Sensors
	 */
	public void getProximitySensorService()
	{
		proximitySensorListener =  new SensorEventListener() {
			...
			public void onSensorChanged(SensorEvent event) {
				...
				if(event.values[0]<=0)
				{
					try 
					{
						Log.d("MediaPlayBackActivity","Sensor active");
						mService.next();
					} 
					catch (RemoteException e) 
					{
	...
	private View.OnClickListener mAccelSensorListener = new View.OnClickListener() {
		public void onClick(View v) {
			//controller = SensorController1.getInstance(getApplicationContext());
			//getSensorServices();
			if (((CheckBox) v).isChecked()) {
				Log.d("Debug","Accelerometer");
				...
				Log.d("Debug","Accelerometer unselected");
				try
				{
					if(accelSensorListener!=null)
					{
						...
						Log.d("MPA","Unregister Method Accelerometer");
					}
					//getSensorServices();
				}
				catch(Exception e)
	...
	private View.OnClickListener mProximitySensorListener = new View.OnClickListener() {
		public void onClick(View v) {
			if (((CheckBox) v).isChecked()) {
				Log.d("Debug","Proximity");
				try
				{
			...
			{
				Log.d("Debug","Proximity unselected");
				try
				{
					if(proximitySensorListener!=null)
					{
						...
						//Log.d("Test","unregister proximity sensor Method call");
					}
				}
				catch(Exception e)
				{
